...
const std::shared_ptr<SDL2pp::Texture> &IObjectView::getM_texture() const {
  return m_texture;
}
const std::shared_ptr<IObjectController> &IObjectView::getM_controller() const {
  return m_controller;
}
const CPosition &IObjectView::getPrev_position() const {
